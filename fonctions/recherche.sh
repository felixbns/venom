...
echo -e -n "$MAGENTA [>]$CYAN Entrez la recherque que vous voulez effectuer : $DEFAULT"
read recherche
sleep 0.6
...
echo -e "$GREEN$BOLD [+]$DEFAULT$CYAN Entrez \"q\" pour quitter la recherche. $DEFAULT
"
sleep 0.2

echo -e "$GREEN$BOLD [+]$DEFAULT$CYAN Voici le résultat de la recherche : $DEFAULT
"
